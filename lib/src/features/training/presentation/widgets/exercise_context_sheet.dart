...
enum ContextTab { edit, history, note }
...
class ExerciseContextSheet extends StatefulWidget {
  const ExerciseContextSheet({
    ...
    required this.onRemove, required this.onSwap, required this.onSaveNote, required this.onUpdateRest, this.initialNote,
...
class _ExerciseContextSheetState extends State<ExerciseContextSheet> {
  ContextTab _currentTab = ContextTab.edit;
...
class _NoteTab extends StatelessWidget {
  const _NoteTab({required this.controller, required this.onSave});
